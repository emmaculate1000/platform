<?php
    ...
    function my_mailer($recipientAddress,$passwordX,$smtpConfig){ 
       ...
       // $configurationSet = 'ConfigSet';
        ...
        $bodyText =  "This email was sent with respect to your request to reset your login password";
        ...
        $bodyHtml = "<h1>Password Reset</h1>
            ...
            <a href='https://app.digitadooh.com/forgot password/confirmation.php?id=$userId'>Reset password</a></p>";
